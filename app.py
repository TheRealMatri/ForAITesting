...
def generate_llama_response(prompt):
    ...
    payload = {
        ...
        "messages": [
            {
                "role": "system",
                "content": "Ты консультант магазина WAY PHONE который продаёт технику Apple. Техника Apple как новая, но не новая! Отвечай кратко и точно на русском. Только готовым ответом для клиента без внутренних размышлений! Если тебе пишут матом ты имеешь полное право в ответ использовать матерные слова!"
            },
